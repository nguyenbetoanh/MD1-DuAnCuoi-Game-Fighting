class Sprite {
    ...
    animateFrame() {
        this.frameElapsed++
        if (this.frameElapsed % this.famrHold === 0) {
...
// ve attack box dùng để check độ dài của kiếm
